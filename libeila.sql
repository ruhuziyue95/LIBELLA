...
CREATE TABLE `zy_category` (
  ...
  `cdesc` varchar(255) DEFAULT '' COMMENT '描述',
  `cimg` varchar(255) DEFAULT NULL COMMENT '图片',
  `cstatus` int(11) DEFAULT '0' COMMENT '状态',
  PRIMARY KEY (`cid`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `zy_details` (
  ...
  `dname` varchar(255) DEFAULT NULL COMMENT '产品名称',
  `dmd` varchar(255) DEFAULT NULL COMMENT '展示图片',
  `dsm` varchar(255) DEFAULT NULL COMMENT '小图片',
  `category_id` int(11) DEFAULT NULL,
  `dbrand` varchar(255) DEFAULT '' COMMENT '品牌',
  `dplace` varchar(255) DEFAULT '' COMMENT '产地',
  `dstyle` varchar(255) DEFAULT '' COMMENT '风格',
  `dmaterial` varchar(255) DEFAULT '' COMMENT '材质',
  `dcolor` varchar(255) DEFAULT '' COMMENT '颜色',
  `dcustomized` varchar(255) DEFAULT '' COMMENT '定制/租赁',
  `dlg` varchar(1000) DEFAULT NULL COMMENT '详情图',
  `dcontent` varchar(2000) DEFAULT '' COMMENT '详情文字描述',
  `dstatus` int(11) DEFAULT '0',
  `dcreate_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间戳',
  PRIMARY KEY (`did`),
